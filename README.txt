...
Now we will copy the SSH keys to the client machine (the one you are installing ansible on). NOTE: you may need to create a key-pair on your local client machine first.
